...
- .
- .
- Ir la sección de "Code" y cargar o copiar el código del Backend. Es importante presionar "Deploy" cada vez que se hace un cambio.
- <img width="1322" alt="image" src="https://github.com/user-attachments/assets/0973bbc6-ba7f-4bd2-a41a-0bd76ecd785b">
- Dirigirse a la sección de configuración y presionar el link con el nombre de la función de Lambda.
- <img width="886" alt="image" src="https://github.com/user-attachments/assets/62edf846-16bd-44db-b81a-54b17ed5c564">
- Seleccionar la opción de "CORS" en el menú de la izquierda.
- Colocar un asterisco (*) en cada uno de los campos que se pueden modificar y guardar los cambios.
- <img width="1121" alt="image" src="https://github.com/user-attachments/assets/81be510e-a0c1-4b01-9ab4-0a3d82c146dc">
